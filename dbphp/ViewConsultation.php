...
elseif(isset($_POST['btn-update'])) //edit/update consultation
{
	...
	if(update())
	{
	 ...
	 else
	 {
	  ?>
	  <script type="text/javascript">
	  alert('Une erreur est survenue lors de la mise à jour de la consultation.');
	  </script>
	  <?php
	 }
} 
...
{
 if(confirm('Etes-vous sur de vouloir supprimer cette consultation? Ceci est une action irreversible.'))
 {
...
<div class="col-md-6 col-md-offset-3">
	...
	<div class="panel panel-default">
		...
		<div class="panel-footer" align="right">
			<?php if($isSecretary and !$isNew) { ?><a href="javascript:delete_id('<?php echo $pid . $mid . $dt; ?>')"><button class="btn btn-danger">Supprimer</button></a> <?php } ?>
